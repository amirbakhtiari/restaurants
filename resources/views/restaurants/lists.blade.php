                    ...
                    <div class="modal-body listComplainModal">
                        <div class="row" style="padding: 10px">
                            ...
                            <div class="col-lg-12 col-md-12">
                                ...
                                <div class="radio ">
                                    <label><input type="radio" name="optradio" >عدم کیفیت </label>
                                </div>
                                <div class="radio ">
                                    <label><input type="radio" name="optradio" >اشتباه در ارسال  </label>
                                </div>
                                <div class="form-group">
                                    <textarea style="border: solid #8c8c8c 1px;resize: none" class="form-control " rows="5" id="comment" placeholder="توضیحات" ng-model="favorite.description"></textarea>
                                </div>
        ...
        <div class="container-fluid" id="service-container-restaurants">
            <div class="row">
                <div class="list-search">
                    ...
                    <form>
                        <div class="form-group input-group col-md-3 col-sm-6 col-xs-12 ten-padding">
                            <input class="form-control" style="border-right: solid 4px #a7221a" type="text" placeholder="نام رستوران را جستجو کنید." ng-model="condition.name" ng-keyup="search()">
                        </div>
                        <div class="form-group input-group col-md-3 col-sm-6 col-xs-12  ten-padding">
                        ...
                        <div class="form-group input-group col-md-3 col-sm-6 col-xs-12  ten-padding">
                            <input type="text" class="form-control" style="-moz-appearance: none;-webkit-appearance: none;" ng-model="condition.zone" ng-keyup="search()" placeholder="نام منطقه"/>
                        </div>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="  background-color: #fff;">
                            <div class="search-restaurant">
                                <div ng-repeat="cf_list in cf_lists">
                                    <div class="inputs-search-services" ng-if="cf_list.iType==3">
                                    ...
                                    <div ng-if="cf_list.iType==7">
                                        <strong ng-bind="cf_list.sName"></strong>
                                        <select class="form-control" ng-change="search()" ng-model="condition.type[cf_list.iID]" >
                                    ...
                                    <div ng-if="cf_list.iType==4">
                                        <div class="checkbox-section">
                                            <div class="checkbox">
                                                <input class="form-control" type="checkbox" id="checked-car-<%$index%>" ng-model="condition.check[cf_list.iID]" ng-false-value="'0'" ng-true-value="'1'" ng-change="search({boolean:'cf_list.iID'})">
                ...
                <div class=" col-lg-9 col-md-9 col-xs-12 xol-sm-12 col-centered white_block">

                    <div class="services_panel" ng-repeat="restaurant in restaurants">
                        <div class="col-md-3">
                            <div class="panel text-center">

                                <img style="width: 100%" ng-if="restaurant.picture" ng-src="data:image/jpeg;base64,<% restaurant.picture %>"/>
                                <img style="width: 100%" ng-if="!restaurant.picture" ng-src="<%'img/noimage.jpg'%>"/>
                                ...
                                <div class="list-item-div">
                                    ...
                                    <p ng-bind="restaurant.address.substr(0, 10)"...></p>
                    ...
                    <ul class="pagination">
                        <li ng-class="{disabled: current_page == 1}"><a class="fa fa-chevron-left" ng-click="getPage(current_page - 1)"></a></li>
                        <li ng-repeat="page in pages" ng-class="{active: current_page == page}">
                            <a ng-click="getPage(page)"><%$index + 1%></a>
                        </li>
                        <li ng-class="{disabled: current_page >= last_page}"><a class="fa fa-chevron-right" ng-click="getPage(current_page + 1)"></a></li>
                    </ul>
                </div>
            </div>
        </div><!-- end .row div -->
